...
def dataset():
    ...
    st.markdown("""
    Durante a análise exploratória dos dados, observou-se que havia registros com valor nulo nos atributos Glucose, BloodPressure, SkinThickness, Insulin e BMI. É sabido que para os dados analisados neste artigo valores iguais a zero, em módulo, representam uma inconsistência. Logo, como pré-processamento, realizou-se a substituição destes valores pela média de seu atributo correspondente.
    """)
